                      ...
                      <TableCell className="px-4 py-3 text-right">
                        <div className="flex items-center justify-end gap-2">
                          <Button
                            ...
                            className="border-border bg-elevated text-text-secondary hover:border-brand-primary/40 hover:bg-brand-primary/10 hover:text-brand-primary"
                          >
                          ...
                          <Button
                            ...
                            className="border-status-danger/30 bg-status-danger-bg text-status-danger hover:bg-status-danger/20 disabled:border-border disabled:bg-elevated disabled:text-text-muted"
                          >
