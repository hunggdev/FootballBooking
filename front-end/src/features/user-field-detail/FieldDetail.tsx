...
import { BookLongTime } from "./BookLongTime";
...
export default function FieldDetail() {
  ...
  const handleConfirm = async () => {
    ...
    setIsBookingClosed(!isBookingClosed);

    setPaymentData({
      bin: "970422",
      accountNumber: "0385878845",
      accountName: "LUONG VIET HUNG",
      amount: deposit,
    ...
    const payloadServices = Object.entries(cart).map(
      ([serviceId, quantity]) => ({
