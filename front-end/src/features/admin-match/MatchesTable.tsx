...
export function MatchesTable({matches, onView, onEdit, onDelete, currentPage, pageSize }: Props) {
          ...
          <TableBody>
            {currentMatches.map((match, index) => (
              <TableRow key={match.matchId}>
                ...
                <TableCell>{match.minAge ?? "Chưa cập nhật"} - {match.maxAge ?? "Chưa cập nhật"}</TableCell>
